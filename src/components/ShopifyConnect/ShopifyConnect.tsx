        ...
        <div className='right_block'>
            <div className='form_wrapper'>
                ...
                <form onSubmit={handleSubmit} className='form'>
                    ...
                    <p>Installs the Chad widget in your Shopify store and sets it up to display your customers’ order information and self-serve options.</p>
                    <div className='benefits'>
                        ...
                        <div className='benefit'>
                            ...
                            <p>Automatically checks your store policy and existing inventory before resolving or escalating each request</p>
                        </div>
                    </div>
                    <button type='submit' disabled={loading}>Connect Store</button>
                </form>
                <a href="#"><p className='link'>I don’t use Shopify</p></a>
            </div>
        </div>
